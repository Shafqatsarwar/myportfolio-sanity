...
import { getProjects } from "@/app/(studio)/sanity/sanity.query";
import type { ProjectType } from "../../../app/(studio)/studio/types/index";
//import type { ProjectType } from "../../../(studio)/studio/types/index";
